        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-6 d-flex align-items-center justify-content-end header-top-info">
                    <span class="mr-2 text-white font-weight-semi-bold font-size-14">Follow Listhub on:</span>
                    ...
                    <div class="menu-full-width">
                        <div class="logo">
                            ...
                            <div class="d-flex align-items-center">
                                <a href="add-listing.html" class="btn-gray add-listing-btn-show font-size-24 mr-2 flex-shrink-0" data-toggle="tooltip" data-placement="left" title="Post Your Ad">
                        ...
                        <div class="nav-right-content">
                            <a href="add-listing.html" class="theme-btn gradient-btn shadow-none add-listing-btn-hide">
                                <i class="la la-plus mr-2"></i>Post Your Ad
                            </a>
...
<section class="hero-wrapper overflow-hidden">
    ...
    <div id="fullscreen-slide-container">
        <ul class="slides-container">
            ...
            <li><img src="~/assets/images/hero-bg5.jpg" alt=""></li>
        </ul>
            ...
            <div class="col-lg-12">
                <div class="hero-heading text-center">
                    <div class="section-heading">
                        <h2 class="sec__title cd-headline">
                            Africa's Largest Classified
                        </span>
                        </h2>
                        <p class="sec__desc">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-heading text-center">
                    ...
                    <h2 class="sec__title">Featured Ads</h2>
                    <p class="sec__desc">
                        Buy & Sell Anything
                    </p>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="section-heading text-center">
                    ...
                    <h2 class="sec__title">Quick and Easy Search </h2>
                    <p class="sec__desc">
        ...
        <div class="row padding-top-60px">
            <div class="col-lg-4 responsive-column">
                <div class="info-box">
                    ...
                    <div class="info-content">
                       <h4 class="info__title">Find Great Place</h4>
                        <p class="info__desc">
            ...
            <div class="col-lg-4 responsive-column">
                <div class="info-box">
                    ...
                    <div class="info-content">
                        <h4 class="info__title">Choose a Category</h4>
                        <p class="info__desc">
                            Proin dapibus nisl ornare diam varius ecos tempus. Aenean a quam
                            luctus, finibus tellus ut, convallis eros.
                        </p>
            ...
            <div class="col-lg-4 responsive-column">
                <div class="info-box">
                    ...
                    <div class="info-content">
                        <h4 class="info__title">Go Have Fun</h4>
                        <p class="info__desc">
                            Proin dapibus nisl ornare diam varius ecos tempus. Aenean a quam
                            luctus, finibus tellus ut, convallis eros.
                        </p>
        ...
        <div class="row">
            <div class="col-lg-4 mx-auto padding-top-30px">
                ...
                <a class="video-box video-box-negative hover-scale-2" target="_blank" href="https://www.youtube.com/watch?v=GlrxcuEDyF8" data-fancybox title="Play Video">
                    <img src="~/assets/images/video-img.jpg" alt="video image">
                    <div class="video-content d-flex align-items-center justify-content-center">
                       <span class="d-block mr-3 font-weight-semi-bold">Click to Watch How It Works</span>
        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="mobile-app-content">
                    <div class="section-heading">
                        ...
                        <h2 class="sec__title mb-3">Discover Amazing Things to do Everywhere You Go</h2>
                    ...
                    <ul class="info-list contact-links">
                        <li class="d-flex align-items-center mb-2"><i class="la la-search icon"></i> Search on the go</li>
                        <li class="d-flex align-items-center mb-2"><i class="la la-file-text-o icon"></i> Real Time Listing</li>
                        <li class="d-flex align-items-center mb-2"><i class="la la-bell icon"></i> Get Latest Info</li>
                    </ul>
            ...
            <div class="col-lg-6">
                <div class="mobile-img">
                    <img src="~/assets/images/map-img.png" alt="map-img">
                    <div class="map-marker map-marker-1 bounce">
                        <img src="~/assets/images/small-img.jpg" alt="">
                        <div class="map-pin-bg"></div>
                    </div><!-- end map-marker -->
                     <div class="map-marker map-marker-2 bounce">
                         <img src="~/assets/images/small-img2.jpg" alt="">
                         <div class="map-pin-bg"></div>
                    </div><!-- end map-marker -->
                    <div class="map-marker map-marker-3 bounce">
                         <img src="~/assets/images/small-img3.jpg" alt="">
                         <div class="map-pin-bg"></div>
                    </div><!-- end map-marker -->
                    <div class="map-marker map-marker-4 bounce">
                         <img src="~/assets/images/small-img4.jpg" alt="">
                         <div class="map-pin-bg"></div>
                    </div><!-- end map-marker -->
                    <div class="map-marker map-marker-5 bounce">
                         <img src="~/assets/images/small-img5.jpg" alt="">
                         <div class="map-pin-bg"></div>
                    </div><!-- end map-marker -->
                    <div class="map-marker map-marker-6 bounce">
                         <img src="~/assets/images/small-img6.jpg" alt="">
                         <div class="map-pin-bg"></div>
                    </div><!-- end map-marker -->
                </div><!-- end mobile-img -->
            </div><!-- end col-lg-6 -->
            ...
            <div class="col-lg-12">
                <div class="cta-content-box cta-content-box-2">
                    <div class="row align-items-center">
                        <div class="col-lg-5">
                            <div class="cta-img">
                                <img class="" src="~/assets/images/img37.jpg" alt="">
                        ...
                        <div class="col-lg-4 mr-auto">
                            <div class="cta-content">
                                <div class="section-heading">
                                    <h2 class="sec__title mb-1 font-size-30 line-height-40">Subscribe to Our Newsletter</h2>
                                    <p class="sec__desc mb-4">Want to be notified about latest update? just sign up.</p>
                                </div><!-- end section-heading -->
                                <form action="#" class="form-box">
                                    <div class="form-group">
                                        <span class="la la-envelope form-icon"></span>
                                        <input class="form-control form-control-styled" type="email" name="email" placeholder="Enter email address">
                                        <p class="font-size-12 font-weight-medium pt-1"><i class="la la-lock mr-1"></i>Your are 100% protected with us</p>
                                    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="copy-right d-flex align-items-center justify-content-between">
                    <p class="copy__desc">
                        &copy; Copyright Listhub <script> document.write(new Date().getFullYear()); </script>.
                    </p>
